...
/*
        ...
        parcelId = parcelRepository.getParcelById();
*/

        Optional<ParcelInfo> parcel = controller.checkParcelStatus(parcelId);
        parcel.ifPresent(this::printParcel);

    }

    private void printParcel(ParcelInfo parcelInfo) {
        System.out.println("nadawca: " + parcelInfo.getShipper());
        System.out.println("odbiorca: " + parcelInfo.getReceiver());
        System.out.println("nr przesyłki: " + parcelInfo.getId());
        System.out.println("status przesyłki: " + parcelInfo.getStatus());
